      ...
      {typeof crypto.name === 'undefined' ? (
        ...
        <div>
          ...
          <ul className="flex links_padding space-x-4 justify-end m-3 lg:my-6">
            ...
            <li className={`${typeof crypto.urls.twitter[0] === 'undefined' ? 'hidden' : 'block'}`}>
              <a href={crypto.urls.twitter}>
                <img src={twitter} alt="twitter" />
              </a>
            </li>
            <li className={`${typeof crypto.urls.reddit[0] === 'undefined' ? 'hidden' : 'block'}`}>
